```@meta
CurrentModule = QuantumGraining
```

# QuantumGraining.jl

Documentation for [QuantumGraining](https://github.com/leonbello/QuantumGraining.jl)

![](imgs/quantumgraining.png)
...
<img src="../imgs/decomp-tree.png" width=50% height=50%>
