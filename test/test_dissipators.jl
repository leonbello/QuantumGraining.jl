...
@testset "dissipators" begin
    ...
    @test simplify(γ_eff_2[((a*σp), (a*σm))].prefacs[1] .- -1im*(g^2//2)*ωc/((ωa + ωc)*(ωa - ωc))) == 0
    @test simplify(γ_eff_2[((a*σp), (a*σm))].prefacs[2] .- 1im*(g^2//2)*ωc/((ωa + ωc)*(ωa - ωc))) == 0
    ...
    @test simplify(γ_eff_2[((a'*σm), (a*σm))].prefacs[1] .- 1im*(g^2//2)*ωa/((ωa + ωc)*(ωa - ωc))) == 0
    @test simplify(γ_eff_2[((a'*σm), (a*σm))].prefacs[2] .- -1im*(g^2//2)*ωa/((ωa + ωc)*(ωa - ωc))) == 0
    ...
    @test simplify(γ_eff_2[((a'*σp), (a'*σp))].prefacs[1] .- -1im*(g^2//2)*1/(ωa + ωc)) == 0
    @test simplify(γ_eff_2[((a'*σp), (a'*σp))].prefacs[2] .- 1im*(g^2//2)*1/(ωa + ωc)) == 0
    ...
    @test length(γ_eff_2[((a*σp), (a'*σp))].exponents) == 2
    @test simplify(γ_eff_2[((a*σp), (a'*σp))].prefacs[1] .- -1im*(g^2//2)*ωa/((ωa + ωc)*(ωa - ωc))) == 0
    @test simplify(γ_eff_2[((a*σp), (a'*σp))].prefacs[2] .- 1im*(g^2//2)*ωa/((ωa + ωc)*(ωa - ωc))) == 0
    @test issetequal(γ_eff_2[((a*σp), (a'*σp))].polys, [[1],[1]])
    ...
    @test simplify(γ_eff_2[((a'*σm), (a'*σp))].prefacs[1] .- 1im*(g^2//2)*ωc/((ωa + ωc)*(ωa - ωc))) == 0
    @test simplify(γ_eff_2[((a'*σm), (a'*σp))].prefacs[2] .- -1im*(g^2//2)*ωc/((ωa + ωc)*(ωa - ωc))) == 0
    ...
    @test issetequal(γ_eff_2[((a'*σm), (a'*σm))].exponents, [4((ωa - ωc)^2), 2((ωa - ωc)^2)])
    @test length(γ_eff_2[((a'*σm), (a'*σm))].exponents) == 2
    @test simplify(γ_eff_2[((a'*σm), (a'*σm))].prefacs[1] .- 1im*(g^2//2)*1/(ωa - ωc)) == 0
    @test simplify(γ_eff_2[((a'*σm), (a'*σm))].prefacs[2] .- -1im*((g^2//2)*1/(ωa - ωc))) == 0
    @test issetequal(γ_eff_2[((a'*σm), (a'*σm))].polys, [[1],[1]])
end